package com.workbzw.app.c_video.utils;

import android.view.View;

import com.workbzw.app.base.AppApplication;
import com.workbzw.app.c_video.controller.FloatController;
import com.workbzw.app.c_video.view.FloatView;
...
public class PIPManager {
    ...
    private PIPManager() {
        mVideoView = new VideoView(AppApplication.getInstance());
        VideoViewManager.instance().add(mVideoView, Tag.PIP);
        mFloatController = new FloatController(AppApplication.getInstance());
        mFloatView = new FloatView(AppApplication.getInstance(), 0, 0);
    }
