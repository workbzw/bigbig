package com.workbzw.app.c_video.view;
...
public class FloatView extends FrameLayout{
    ...
    private void init() {
        setBackgroundResource(R.drawable.c_video_shape_float_window_background);
    ...
    private void initWindow() {
        ...
        mParams.windowAnimations = R.style.c_video_FloatWindowAnimation;
